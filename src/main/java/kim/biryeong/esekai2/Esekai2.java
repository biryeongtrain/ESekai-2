...
import kim.biryeong.esekai2.impl.player.resource.PlayerResourceBootstrap;
import kim.biryeong.esekai2.impl.player.resource.PlayerResourceRuntimeManager;
...
public class Esekai2 implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        PlayerCombatStatService.bootstrap();
        ServerRuntimeAccess.bootstrap();
        PlayerResourceBootstrap.bootstrap();
        PlayerResourceRuntimeManager.bootstrap();
